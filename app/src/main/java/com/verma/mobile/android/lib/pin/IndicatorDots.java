...
public class IndicatorDots extends LinearLayout {
    ...
    @IntDef({com.verma.mobile.android.lib.pin.IndicatorDots.IndicatorType.FIXED,
            com.verma.mobile.android.lib.pin.IndicatorDots.IndicatorType.FILL,
            com.verma.mobile.android.lib.pin.IndicatorDots.IndicatorType.FILL_WITH_ANIMATION})
    ...
    public IndicatorDots(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            ...
            mIndicatorType = typedArray.getInt(R.styleable.PinLockView_indicatorType,
                    IndicatorDots.IndicatorType.FIXED);
        } finally {
            typedArray.recycle();
        }
    ...
    public
    @IndicatorDots.IndicatorType
    int getIndicatorType() {
        return mIndicatorType;
    }

    public void setIndicatorType(@IndicatorDots.IndicatorType int type) {
